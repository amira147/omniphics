...
define('SECRET_SALT','fey3dgiftanbvue');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','admin@omniphics.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost'); 
define('DBNAME','omniphics_osti1');
define('DBUSER','omniphics_osti1');
define('DBPASS','wkwSR00aq1eV6');
